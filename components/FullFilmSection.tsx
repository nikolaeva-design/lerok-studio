    ...
    >
      <div className="relative mx-auto w-full max-w-[1600px] overflow-hidden rounded-[18px] bg-[#0a0a0a] shadow-[inset_0_0_100px_rgba(0,0,0,0.35)] sm:rounded-[22px] md:rounded-[32px]">
        <Link
          ...
          className="group relative block min-h-[72svh] w-full cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#b22222] focus-visible:ring-offset-2 focus-visible:ring-offset-black md:min-h-[min(78svh,900px)]"
        >
          ...
          <div className="relative z-[4] flex min-h-[72svh] flex-col items-center justify-end px-5 pb-8 pt-10 text-center sm:pb-10 md:min-h-[min(78svh,900px)] md:px-10 md:pb-12 md:pt-14">
            <div className="max-w-[40rem]">
              ...
              <p className="mx-auto mt-4 max-w-none font-[family-name:var(--font-sans)] text-[11px] leading-tight text-white/90 sm:text-sm whitespace-nowrap">
